...
let primitive_names_to_labels = 
  ["boolean?", "is_boolean"; "float?", "is_float"; "integer?", "is_integer"; "pair?", "is_pair";
   ...
   (*"car", "car"; "cdr", "cdr"; "cons", "cons"; "set-car!", "set_car"; "set-cdr!", "set_cdr"; "apply", "apply"*)  (*i added the primitive functions here *)
...
"    MAKE_CLOSURE(rax, SOB_NIL_ADDRESS, " ^ label  ^ ")
    mov [fvar_tbl+" ^  (string_of_int (List.assoc prim fvars_tbl)) ^ "], rax
    " in
...
try
  ...
  let asts = Code_Gen.rename_ast asts in  
  let asts = Code_Gen.ast_without_tagggedSexpr asts in 
